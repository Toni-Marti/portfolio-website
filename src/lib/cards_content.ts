...
export const cards_content: Array<ProjectInfo> = [
  ...
  },
  {
    ...
    description: [
      ...
      "First tried to set it up right when I started university, so it was way before I had sufficient knowledge to do so. Since then, it was presented me with a hole bunch of unsuspected challenges, as any server administrator would face.",
